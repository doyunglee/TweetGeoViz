...
def tweeting(epi,r1,r2,tI,tF):
    ...
    print results
    local_tweets_df = results.query('(epi[0]-r1<results.tlt<epi[0]+r1)&(epi[0]-r1<results.tln<epi[0]+r1)');
    wide_tweets_df = results.query('!((epi[0]-r1<results.tlt<epi+r1)&(epi[0]-r1<results.tln<epi[0]+r1))');
