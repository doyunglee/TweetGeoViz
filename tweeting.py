...
def tweeting(epi,r1,r2,tI,tF):
    ...
    diff_tweets_avg = np.absolute(np.subtract(local_tweets_avg.astype(float),wide_area_tweets_avg.astype(float))/np.add(local_tweets_avg.astype(float), wide_area_tweets_avg.astype(float))-.5)
